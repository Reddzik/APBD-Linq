...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        {
            var res = Emps.Where(e => e.Job == "Frontent programmer" && e.Salary > 1000)
        ...
        {
            var res = Emps
                            .Join(Depts, e => e.Deptno, d => d.Deptno, (e, d) =>
                               new
                               {
                                   e,
                                   d
        ...
        {
            var anonArray = new[] { new { Ename = "Brak wartości" }, new { Ename = "Brak wartości" } };
            var res = Emps.Select(emp => emp.Ename).Union(anonArray.Select(a=>a.Ename));
        }
